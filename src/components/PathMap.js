...
export default function PathMap() {
    ...
    // const path1 = gps.map((a) => {
    //     return [a.car_location_GPS_Y, a.car_location_GPS_X];
    // }
    // )

    const path2 = gps.map((a) => {
        return [a.car_location_GPS_Y, a.car_location_GPS_X];
    }
    )
    ...
    return (
        <div id="wrap">
            ...
            <ToggleButtonGroup type="checkbox" defaultValue={[1, 3]} className="mb-2">
                ...
                <ToggleButton onClick={() => setMapSize([800, 800])} id="tbg-check-2" value={2}>
                    크게보기
                </ToggleButton>
            ...
            <Box5 />
            <ToggleButtonGroup type="checkbox" defaultValue={[1, 3]} className="mb-2">
                <ToggleButton onClick={() => setBuspaths(path2)} id="tbg-check-1" value={1}>
                    버스 운행 경로 보기
                </ToggleButton>
