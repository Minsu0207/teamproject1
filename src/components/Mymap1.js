...
//         // const myPath1 = (new kakao.maps.LatLng("35.198742898617816", "129.12954324249225")
//         // );


//         console.log(db[5]?.y_gps)
//         console.log(db[5]?.x_gps)
//         //마커 좌표
...
//     useEffect(() => {
//         const goBus = setTimeout(() => setCnt(cnt + 100), 1000);
//         console.log(cnt)
...
//     return (
//         <>
//             <button onClick={() => { }}>경로확인{cnt}</button>
//             <div
//                 id="map" style={{
//                     width: '90%',
//                     height: '800px'
